...
SRC		=	mlx.c get_next_line/get_next_line.c get_next_line/get_next_line_utils.c \
            ...
            get_sprites_list.c check_symbols.c go_th_params.c init_z_buffer.c parse_line_sect.c parse_params_except.c is_map_start.c get_check_params.c get_check_tex.c sortSprites.c
